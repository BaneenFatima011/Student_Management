...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_attendance = "SELECT A.STUDENT_ID, C.NAME, A.OBT_MARKS ,A.TOTAL_MARKS, A.NAME, A.category, A.FACULTY_ID, F.COURSE_NAME  FROM GRADES A, CREDENTIALS C, COURSES F WHERE A.STUDENT_ID = C.ID AND F.COURSE_ID = '$course' AND A.COURSE_ID = '$course'  ";
